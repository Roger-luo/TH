...
static FunctionDescription THVector_(cmul_DISPATCHTABLE)[] = {
      ...
      FUNCTION_IMPL(THVector_(cmul_AVX2), SIMDExtension_AVX2),
    #endif
  #endif
...
static FunctionDescription THVector_(muls_DISPATCHTABLE)[] = {
  ...
  #if defined(USE_AVX2)
    #if defined(TH_NTYPE_IS_COMPLEX)
      FUNCTION_IMPL(THVector_(muls_AVX2), SIMDExtension_AVX2),
    #endif
  #endif
...
static FunctionDescription THVector_(cdiv_DISPATCHTABLE)[] = {
  ...
  #if defined(USE_AVX2)
    #if defined(TH_NTYPE_IS_COMPLEX)
      FUNCTION_IMPL(THVector_(cdiv_AVX2), SIMDExtension_AVX2),
    #endif
  #endif
...
static FunctionDescription THVector_(divs_DISPATCHTABLE)[] = {
  ...
  #if defined(USE_AVX2)
    #if defined(TH_NTYPE_IS_COMPLEX)
      FUNCTION_IMPL(THVector_(divs_AVX2), SIMDExtension_AVX2),
    #endif
  #endif
