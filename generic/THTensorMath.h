...
TH_API void THTensor_(abs)(THPartTensor *r_, THTensor *t);
TH_API void THTensor_(real)(THPartTensor *r_, THTensor *t);
TH_API void THTensor_(imag)(THPartTensor *r_, THTensor *t);
TH_API void THTensor_(arg)(THPartTensor *r_, THTensor *t);
TH_API void THTensor_(proj)(THPartTensor *r_, THTensor *t);
